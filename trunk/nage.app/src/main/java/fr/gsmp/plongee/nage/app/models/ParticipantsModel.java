 ...
 * 
 */
public class ParticipantsModel extends AbstractTableModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2104625523008582691L;
	...
	private final String[] entetes = { "Nom", "Prénom", "Année", "Club",
			"Licence", "Equipement","Categorie age","Sexe","Numéro tuba" };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			// Annee
			return participants.get(rowIndex).getParticipantdatenaissance();
		...
		case 4:
			// Licence
			return participants.get(rowIndex).getParticipantlicence();
		case 5:
